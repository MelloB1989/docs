...
```go
kai := ai.NewKarmaAI(
  ai.ChatModelGPT4oMini,         // pick a model
...
* `ai.ChatModelGPT4oMini` (OpenAI)
* `ai.ModelClaude3_7SonnetLatest` (Anthropic Claude 3.7 Sonnet)
* `ai.GROK_3_MINI` and `ai.GROK_4_0709` (xAI Grok)
